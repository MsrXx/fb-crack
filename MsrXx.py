...
for xd in range(10000):
	...
	k='Chrome/76.0.3809.132 Mobile Safari/537.36'
...
""")
	iyan_holle(f"""(=)PREMIUM\n(=)Whatsapp:{M}081283099471 \n(=){P}XTC|CODETEAM""")
	iyan_holle('=' * 40)
#--------------------[ MASUK ]--------------#
def login():
	try:
...
def menu(my_name,my_id):
	...
	iyan_holle('=' * 40)
	iyan_holle = input(' Select : ')
	iyan_holle('=' * 40)
	if msx_iyan_holle in ['1']:
		dump_massal()
	elif msx_iyan_holle in ['0']:
